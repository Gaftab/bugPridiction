...
ax = fig.add_subplot()
rects1 = ax.bar(x - width*2, acurracy, width, label='Acurracy')
rects2 = ax.bar(x - width, pre, width, label='Precision')
rects3 = ax.bar(x, re, width, label='Recall')
rects4 = ax.bar(x + width*2, aoc, width, label='ROC')
rects5 = ax.bar(x + width, f1, width, label='F1')
...
ax.set_title('Results of the experimented Classifiers for for CMI dataset')
ax.set_xticks(x)
