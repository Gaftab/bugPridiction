...
csv = r'/content/drive/MyDrive/softwareBugPred/bugPridiction/data/mc1.csv'
...
# 3.1) SVM
clf=svm.SVC(C=0.001,gamma=0.01,kernel="rbf")
...
clf=RandomForestClassifier( max_features= 'auto', n_estimators= 200)
...
clf=GradientBoostingClassifier(loss='deviance', max_features='log2',n_estimators=100, learning_rate=0.05, max_depth=8)
...
ax.set_title('Results of the experimented Classifiers for MC1 dataset')
ax.set_xticks(x)
