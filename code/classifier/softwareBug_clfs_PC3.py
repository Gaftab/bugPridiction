...
# search.best_params_
# Rf_best_par=search.best_params_
# print('ExtraTreesClassifier Best Parameters ',Rf_best_par)
...
ax.set_title('Results of the experimented Classifiers for for PC3 dataset')
ax.set_xticks(x)
